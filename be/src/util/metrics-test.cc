...
TEST_F(MetricsTest, CounterMetrics) {
  ...
  IntCounter* int_counter = metrics.AddCounter("counter", 0LL);
  ...
  IntCounter* int_counter_with_units =
      metrics.AddCounter("counter_with_units", 10LL);
...
TEST_F(MetricsTest, GaugeMetrics) {
  ...
  IntGauge* int_gauge = metrics.AddGauge("gauge", 0LL);
  ...
  IntGauge* int_gauge_with_units =
      metrics.AddGauge("gauge_with_units", 10LL);
...
TEST_F(MetricsTest, CountersJson) {
  ...
  metrics.AddCounter("counter", 0LL);
  Document document;
  Value val;
